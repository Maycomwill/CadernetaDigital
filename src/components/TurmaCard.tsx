...
function TurmaCardRoot({ children }: TurmaCardRootProps) {
  return (
    <div className="h-40 max-h-44 flex flex-col items-center justify-evenly gap-2 bg-gray-800 rounded-md w-72 md:w-80 px-4 py-4 text-center border-b-4 border-green-500">
      {children}
    </div>
  );
}
